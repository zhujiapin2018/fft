...
#include "soc/mcpwm_struct.h"
 ...
 //定义LCD的尺寸	
//extern uint16_t SPI_LCD_RAM[240*240];//缓存大小
...
//IO连接  
#define PIN_NUM_MISO 22 	// SPI MISO
#define PIN_NUM_MOSI 19		// SPI MOSI
#define PIN_NUM_CLK  21		// SPI CLOCK pin
...
#define PIN_NUM_RST  -1  	// GPIO used for RESET control
#define PIN_NUM_BCKL  2     // GPIO used for backlight control
